...
import type { ExternalBlob as _ExternalBlob, Song as _Song, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addSongToPlaylist(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getLikedSongs(arg0: Principal): Promise<Array<bigint>> {
        if (this.processError) {
            try {
    ...
    async uploadSong(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadSong(arg0, arg1, arg2, arg3, arg4, arg5, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Song_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Song): Promise<Song> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        album: value.album,
        audioBlob: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.audioBlob)),
        likes: value.likes,
        genre: value.genre,
        artist: value.artist,
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Song>): Promise<Array<Song>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Song_n11(_uploadFile, _downloadFile, x)));
}
